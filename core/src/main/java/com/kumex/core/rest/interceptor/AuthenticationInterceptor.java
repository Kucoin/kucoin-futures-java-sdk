 ...
 */
package com.kumex.core.rest.interceptor;
...
import static com.kumex.core.constants.APIConstants.API_HEADER_PASSPHRASE;
...
public class AuthenticationInterceptor implements Interceptor {
     ...
     * @throws KumexApiException in case of any error
     */
     ...
     * @throws KumexApiException in case of any error
     */
    protected void validateCredentials() throws KumexApiException {
        String humanMessage = ". Please check environment variables or VM options";
        if (Strings.isNullOrEmpty(this.apiKey)) {
            throw new KumexApiException("Missing " + APIConstants.API_HEADER_KEY + humanMessage);
        }
        if (Strings.isNullOrEmpty(this.secret)) {
            throw new KumexApiException("Missing " + APIConstants.USER_API_SECRET + humanMessage);
        }
        if (Strings.isNullOrEmpty(this.passPhrase)) {
            throw new KumexApiException("Missing " + APIConstants.API_HEADER_PASSPHRASE + humanMessage);
        }
    }
